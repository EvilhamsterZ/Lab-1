...
Название ниже
1)Для запуска требуется С++ Visual Studio 2019
____
2)открываем файл "ConsoleApplication18.sln"
____
3)открывается программный код консольного приложения
____
4)нажимаем f5 для запуска отладчика
____
5)вводим переменные
____
